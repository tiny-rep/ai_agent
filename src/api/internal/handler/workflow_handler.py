...
from pkg.reponse import validate_error_json, success_json, success_message, compact_generate_response
...
class WorkflowHandler:
    ...
    def get_workflows_with_page(self):
        ...
        # 2.获取分页列表数据
        workflows, paginator = self.workflow_service.get_workflow_with_page(req, current_user)
