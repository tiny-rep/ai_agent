...
from ..model import Account, App, Message
...
class AnalysisService(BaseService):
    ...
    def get_app_analysis(self, app_id: UUID, account: Account) -> dict[str, Any]:
        ...
        fields = [
            ...
            "total_output_rate", "cost_consumption"
        ]
    ...
    @classmethod
    def calculate_trend_by_messages(cls,
                                    end_at: datetime, days_ago: int, messages: list[Message]) -> dict[str, Any]:
