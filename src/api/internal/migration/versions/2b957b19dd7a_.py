...
Revision ID: 2b957b19dd7a
Revises: 3f3cc214dfd6
Create Date: 2025-02-26 10:32:59.253266
...
revision = '2b957b19dd7a'
down_revision = '3f3cc214dfd6'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('account', schema=None) as batch_op:
        batch_op.create_index('account_email_index', ['email'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('account', schema=None) as batch_op:
        batch_op.drop_index('account_email_index')
